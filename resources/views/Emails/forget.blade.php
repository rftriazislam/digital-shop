          ...
          <div class="ps-section__left">
            <div class="ps-form--account ps-tab-rsoot" >
              <div class="ps-tab-list">
                ...
                <div style="width:100%;max-width:100%;margin-right:0;padding:20px 15px;"><a style="font-size:24px;line-height:1em;color:#666;font-weight:600;">Forget Password</a></div>
                ...
                <form method="POST" action="{{ route('sendemail') }}">
                  ...
                  <div class="ps-form__content">
                    ...
                    <div class="form-group submit">
                      <button class="ps-btn ps-btn--fullwidth">Send Link</button>
                    </div>
                  </div>
                </form>
