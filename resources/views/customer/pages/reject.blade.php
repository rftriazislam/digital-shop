   ...
   <div class="row">
                        ...
                        <div class="col-sm-12 ">
                            <div class="form-group">
                                ...
                                <input class="form-control" disabled name="phone" value="{{ $data->social_link }}" type="text" placeholder="" />
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" disabled required rows="6" name="description">{{ $data->description }} </textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
        ...
        <section class="ps-card">
         ...
         <hr>
               ...
               <div  class="ps-form__submit text-center ">
                       ...
                       @else
                       <button class=" ps-btn success" style="background: #673ab7;color:white">
                       <a  >Inactive</a>
                       </button> 
                       <button class=" ps-btn ">
                        <a 
                       ...
                       @endif
                           ...
                           <a style="color:white" >Rejected</a>
                          </button> 
                           @endif
    ...
    <div class="modal-dialog" role="document" style="margin-top: 183px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('customer.reject_message') }}">
                    ...
                    <div class="form-group row mb-0">
                        ...
                        <div class="col-md-8 offset-md-4">
                            <div class="form-group submit">
                                <button class="ps-btn ps-btn">Send Message</button>
                              </div>
